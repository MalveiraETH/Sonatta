  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (test) {
        ...
        // Se estiver estendendo, criar novo agendamento
        if (extendMode && formData.end_date && formData.time) {
          await base44.entities.Appointment.create({
            ...
            type: 'retorno',
            status: 'agendado',
            notes: `Retorno de teste estendido - ${test?.test_number}`
          });
        }

        toast.success(extendMode ? 'Teste estendido e agendamento criado' : 'Teste atualizado');
      } else {
          ...
          <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  Um agendamento de retorno será criado automaticamente para a data final do teste.
                </p>
              </div>
            </div>
          }
